...
# Experiment 2 : PycnoPie

### Authored by: Nikita Sridhar

*Data and analysis for PycnoPie, an experiment on the effect of sunflower stars on urchin grazing of kelp with urchins from barrens and kelp forests that was run in the summer of 2024 in Sitka, AK.*
...
| docs/PycnoPie_report.qmd | Main analysis of kelp data including building models, post-hoc tests, and plotting graphs. |
...
Output of PycnoPie report can be found [here](https://nikita-sridhar.github.io/PycnoPie/PycnoPie_report.html).
